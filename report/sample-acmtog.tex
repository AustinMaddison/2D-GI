...
\begin{itemize}
  ...
  \item \textbf{Real-Time Irradiance Probes}: Details on implementing irradiance probes on the GPU for fast and scalable GI.
\end{itemize}
...
\subsection{Real-Time Irradiance Probes}
